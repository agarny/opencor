...
static const char *Cellml_2_0_Format = "http://identifiers.org/combine.specifications/cellml.2.0";
...
CombineArchiveFile::Format CombineArchiveFile::format(const QString &pFormat)
{
    ...
    if (pFormat == Cellml_2_0_Format) {
        return Format::Cellml_2_0;
    }
...
bool CombineArchive::save(const QString &pFileName)
{
    ...
    for (const auto &file : mFiles) {
        ...
        case CombineArchiveFile::Format::Cellml_1_1:
            ...
            break;
        case CombineArchiveFile::Format::Cellml_2_0:
