...
void CellMLToolsPlugin::updateGui(Plugin *pViewPlugin, const QString &pFileName)
{
    ...
    mExportToCellml20Action->setEnabled(   (cellmlVersion == CellMLSupport::CellmlFile::Version::Cellml_1_0)
...
void CellMLToolsPlugin::initializePlugin()
{
    ...
    connect(mExportToCellml10Action, &QAction::triggered,
            this, &CellMLToolsPlugin::exportToFormat);
            ...
            if (fileManagerInstance->manage(fileName,
                ...
                case Command::Export:
                    if (!cellmlFile->load()) {
                        ...
                        static const QString Cellml20 = "cellml_2_0";
                        ...
                        static const QStringList formatsAndLanguages = { Cellml10, Cellml20, C, Fortran77, Matlab, Python };
                        ...
                        if (!formatsAndLanguages.contains(formatOrLanguage)) {
                        ...
                        } else if (   (formatOrLanguage == Cellml20)
                            ...
                            if (formatOrLanguage == Cellml10) {
                                ...
                                exportOk = cellmlFile->exportTo({}, CellMLSupport::CellmlFile::Version::Cellml_2_0);
...
void CellMLToolsPlugin::exportToFormat()
{
